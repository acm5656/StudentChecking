...
public class SymmetricEncoderUtil {
    private static int randomSource = 128;
   ...
   */
    public static String AESEncode(String encodeRules,String content){
        try {
            ...
            //生成一个randomSource 128/192位的随机源,根据传入的字节数组
            keygen.init(randomSource, new SecureRandom(encodeRules.getBytes()));
              //3.产生原始对称密钥
    ...
    public static String AESDncode(String encodeRules,String content){
        ...
        try {
            byte_content = new BASE64Decoder().decodeBuffer(content);
        } catch (IOException e) {
            e.printStackTrace();
        }
            /*
