...
//    private static final String keyBytes = "abcdefgabcdefg12";
     ...
     *加密
     */
    public static String encode(String keyBytes,String content){
        //加密之后的字节数组,转成16进制的字符串形式输出
        return new BASE64Encoder().encode(parseByte2HexStr(encrypt(content, keyBytes)).getBytes());
    }

    /**
     *解密
     */
    public static String decode(String keyBytes,String content){
